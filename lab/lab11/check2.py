...
class BallDraw(object):
    def __init__ (self, parent):
        ...
        self.Ball = Ball.Ball(80, 200, 6, -3, 10, "red")
        '''
    ...
    def draw_ball(self):
        ...
        bounding_box = (self.Ball.x-self.Ball.radius, \
    ...
    def animate(self):
        ...
        while 0 < self.Ball.x + self.Ball.radius and \
              self.Ball.x - self.Ball.radius < self.maxx and \
              0 < self.Ball.y + self.Ball.radius and \
              self.Ball.y - self.Ball.radius < self.maxy and \
              not self.isstopped:
            # Move the ball
            self.draw_ball()
